...
void main() {
  group('Post.fromLaravel', () {
    test('parses Laravel JSON API response with includes as object', () {
          ...
          "includes": {
            "organization": {
              ...
              "attributes": {
                ...
                "bio":
                    "Reiciendis odio nesciunt est aliquam quia praesentium.",
                "logo":
      ...
      expect(post.id, "1");
      expect(post.title, "Deserunt voluptates necessitatibus atque consequatur.");
      expect(post.slug, "deserunt-voluptates-necessitatibus-atque-consequatur");
      expect(post.cover, startsWith("https://images.unsplash.com/photo-1488521787991"));
      expect(post.content, contains("Reprehenderit voluptatum et sapiente magni"));
