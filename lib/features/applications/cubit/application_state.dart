...
class ApplicationState with _$ApplicationState {
  ...
  const factory ApplicationState.alreadyApplied(Application application) = _AlreadyApplied;
  const factory ApplicationState.submitting() = _Submitting;
  const factory ApplicationState.submitted(Application application) = _Submitted;
